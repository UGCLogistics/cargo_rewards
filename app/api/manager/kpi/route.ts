...
/**
 * Returns KPI metrics for managers. Managers see the same aggregates as
 * administrators but require the MANAGER or ADMIN role. This endpoint
 * mirrors the admin KPI endpoint.
 */
