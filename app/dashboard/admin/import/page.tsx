...
/**
 * AdminImportTransactionsPage allows administrators to upload a CSV or
 * Excel file of transactions and import them in bulk. Files must
 * contain at least the columns: user_id, date (YYYY-MM-DD), service,
 * origin, destination, publish_rate and optionally invoice_no. After
 * selecting a file, the contents are previewed and submitted to the
 * `/api/admin/import-transactions` endpoint. Only ADMIN/STAFF/manager
 * roles may import via the API, but this page is under the admin
 * namespace.
 */
export default function AdminImportTransactionsPage() {
  ...
  return (
    <DashboardLayout>
      ...
      <p>Unggah file CSV atau Excel dengan kolom: <code>user_id</code>, <code>date</code>, <code>service</code>, <code>origin</code>, <code>destination</code>, <code>publish_rate</code>, [<code>invoice_no</code>].</p>
