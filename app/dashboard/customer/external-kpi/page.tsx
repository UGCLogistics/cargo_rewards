...
export default function CustomerExternalKpiPage() {
  ...
  const applyFilters = async () => {
    ...
    try {
      ...
      // Fetch detail for current customer (RLS ensures only own data)
      const detailRes = await fetch(`/api/customer/kpi/detail?${params.toString()}`);
  ...
  return (
    <DashboardLayout>
      <h1>Dashboard KPI Eksternal (Customer)</h1>
