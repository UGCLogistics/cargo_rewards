...
/**
 * ManagerMembershipPage displays membership tiers for all users. Managers
 * can optionally filter by a date range. Data is fetched from
 * `/api/manager/membership`, which is restricted to MANAGER and ADMIN roles.
 */
export default function ManagerMembershipPage() {
  ...
  const fetchMemberships = async () => {
    setLoading(true);
    try {
      let url = '/api/manager/membership';
