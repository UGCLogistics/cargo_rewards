...
export default function TransactionsPage() {
  ...
  // Untuk CUSTOMER: otomatis set perusahaan ke perusahaannya sendiri,
  // tapi dropdown tetap disabled (hanya indikator).
  useEffect(() => {
  ...
  // --- daftar opsi perusahaan (berdasarkan data yang TERLOAD dari server) ---
  ...
  // Karena filter perusahaan sudah dilakukan di server,
  // di sisi client kita tidak perlu filter lagi.
  const totalPages =
